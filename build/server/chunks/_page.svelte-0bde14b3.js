...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.form === void 0 && $$bindings.form && form !== void 0)
    $$bindings.form(form);
  return `<div class="flex items-center justify-center h-screen bg-gray-900"><div class="w-1/4 bg-gray-800 rounded-lg shadow-lg p-14"><h2 class="text-center text-4xl font-bold text-white mb-6">Sign In</h2>
	  <form action="?/login" method="POST"><div class="mb-8"><label class="block text-white text-lg font-bold mb-2" for="username">Username</label>
		...
		<div class="flex items-center justify-center"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-5 px-20 rounded focus:outline-none focus:shadow-outline" type="submit">Sign In</button></div>

		${form?.error ? `<p class="text-red-500 mt-2 text-center">${escape(form.error)}</p>` : ``}</form></div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-0bde14b3.js.map
